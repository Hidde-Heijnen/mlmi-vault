The most common assumption is that outputs are **independent and identically distributed (i.i.d.)**. This assumption allows us to model the joint likelihood of the data as a product of individual likelihoods.
